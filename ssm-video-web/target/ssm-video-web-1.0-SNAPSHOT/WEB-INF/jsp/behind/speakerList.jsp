...
<div class="container" style="margin-top: 20px;">
    ...
    <table class="table table-bordered table-hover"
        ...
        <tbody>
        <c:forEach items="${speaker}" var="speaker" varStatus="status">
            <tr>
                <td>${speaker.id}</td>
    ...
    <tr>
        ...
        <td colspan="1" align="center" ><a href="/speaker/showSpeakerList?pageNum=1">首页&nbsp&nbsp&nbsp&nbsp&nbsp</a></td>
        <td colspan="1" align="center" ><a href="/speaker/showSpeakerList?pageNum=${page.pageNum-1}">上一页&nbsp&nbsp&nbsp&nbsp&nbsp</a></td>
        <td colspan="1" align="center" ><a href="/speaker/showSpeakerList?pageNum=${page.pageNum+1}">下一页&nbsp&nbsp&nbsp&nbsp&nbsp</a></td>
        <td colspan="1" align="center" ><a href="/speaker/showSpeakerList?pageNum=${page.pages}">尾页&nbsp&nbsp&nbsp&nbsp&nbsp</a></td>
        <td colspan="1" align="center" ><a >第${page.pageNum}页&nbsp&nbsp&nbsp&nbsp&nbsp</a></td>
        <td colspan="1" align="center" ><a >共${page.pages}页&nbsp&nbsp&nbsp&nbsp&nbsp</a></td>-
